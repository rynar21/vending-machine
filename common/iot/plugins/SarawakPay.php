...
class SarawakPay
{
    const SP_PUBLIC_KEY          = "C:\wamp64\www/vending-machine\common\iot\keys/sarawakpay_public_key.pem";
    const MERCHANT_PUBLIC_KEY    = "C:\wamp64\www/vending-machine\common\iot\keys/merchant_public_key.key";
    const MERCHANT_PRIVATE_KEY   = "C:\wamp64\www/vending-machine\common\iot\keys/merchant_private_key.key";
